...
# Slot: datumNetzreserve 

<div data-search-exclude markdown="1">



URI: [mastr:slot/datumNetzreserve](https://example.org/mastr/slot/datumNetzreserve)
...
| ---  | ---  |
| self | mastr:datumNetzreserve |
| native | mastr:datumNetzreserve |
