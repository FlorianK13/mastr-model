...
_Anzahl der Module dieser Stromerzeugungseinheit_
...
URI: [mastr:slot/anzahlModule](https://example.org/mastr/slot/anzahlModule)
...
| ---  | ---  |
| self | mastr:anzahlModule |
| native | mastr:anzahlModule |
