...
_Koordinaten der Einheit: Breitengrad_
...
URI: [mastr:slot/breitengrad](https://example.org/mastr/slot/breitengrad)
...
| ---  | ---  |
| self | mastr:breitengrad |
| native | mastr:breitengrad |
