...
_Internetadresse des Marktakteurs. Nicht-vorhanden Flag_
...
URI: [mastr:slot/webseiteNv](https://example.org/mastr/slot/webseiteNv)
...
| ---  | ---  |
| self | mastr:webseiteNv |
| native | mastr:webseiteNv |
