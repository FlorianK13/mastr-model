...
# Slot: gemeindeschluessel 


_Standort der Einheit: Gemeindeschlüssel_
...
URI: [mastr:slot/gemeindeschluessel](https://example.org/mastr/slot/gemeindeschluessel)
...
| ---  | ---  |
| self | mastr:gemeindeschluessel |
| native | mastr:gemeindeschluessel |
