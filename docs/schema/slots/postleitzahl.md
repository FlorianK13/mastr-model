...
URI: [mastr:slot/postleitzahl](https://example.org/mastr/slot/postleitzahl)
...
| Domain Of | [Einheit](../classes/Einheit.md), [Marktakteur](../classes/Marktakteur.md) |
...
| ---  | ---  |
| self | mastr:postleitzahl |
| native | mastr:postleitzahl |
