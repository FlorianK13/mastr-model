...
URI: [mastr:slot/netzbetreiberMaStRNummer](https://example.org/mastr/slot/netzbetreiberMaStRNummer)
...
| ---  | ---  |
| self | mastr:netzbetreiberMaStRNummer |
| native | mastr:netzbetreiberMaStRNummer |
