...
_Spannungsebene des Netzanschlusspunktes. Katalogwert: Spannungsebene_
...
URI: [mastr:slot/spannungsebene](https://example.org/mastr/slot/spannungsebene)
...
| ---  | ---  |
| self | mastr:spannungsebene |
| native | mastr:spannungsebene |
