...
# Slot: einheitBetriebsstatus 

<div data-search-exclude markdown="1">



URI: [mastr:slot/einheitBetriebsstatus](https://example.org/mastr/slot/einheitBetriebsstatus)
...
| Domain Of | [Einheit](../classes/Einheit.md), [GeloeschteUndDeaktivierteEinheit](../classes/GeloeschteUndDeaktivierteEinheit.md) |
...
| ---  | ---  |
| self | mastr:einheitBetriebsstatus |
| native | mastr:einheitBetriebsstatus |
