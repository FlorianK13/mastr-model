...
# Slot: datumBeginnVoruebergehendeStilllegung 


_Beginn der vorläufigen Stilllegung der Einheit_
...
URI: [mastr:slot/datumBeginnVoruebergehendeStilllegung](https://example.org/mastr/slot/datumBeginnVoruebergehendeStilllegung)
...
| ---  | ---  |
| self | mastr:datumBeginnVoruebergehendeStilllegung |
| native | mastr:datumBeginnVoruebergehendeStilllegung |
