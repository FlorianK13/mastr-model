...
# Slot: datumDesBetreiberwechsels 


_Datum des realen Betreiberwechsels_
...
URI: [mastr:slot/datumDesBetreiberwechsels](https://example.org/mastr/slot/datumDesBetreiberwechsels)
...
| ---  | ---  |
| self | mastr:datumDesBetreiberwechsels |
| native | mastr:datumDesBetreiberwechsels |
