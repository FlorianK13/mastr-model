...
URI: [mastr:slot/weitereBrennstoffe](https://example.org/mastr/slot/weitereBrennstoffe)
...
| ---  | ---  |
| self | mastr:weitereBrennstoffe |
| native | mastr:weitereBrennstoffe |
