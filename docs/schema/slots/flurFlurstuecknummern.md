...
# Slot: flurFlurstuecknummern 


_Standort der Einheit: Flur und/oder Flurstücke_
...
URI: [mastr:slot/flurFlurstuecknummern](https://example.org/mastr/slot/flurFlurstuecknummern)
...
| ---  | ---  |
| self | mastr:flurFlurstuecknummern |
| native | mastr:flurFlurstuecknummern |
