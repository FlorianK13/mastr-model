...
_Auflistung der zugeordneten Marktrollen und deren Daten. Kommasepariert. Objekt: Marktrolle_
...
URI: [mastr:slot/marktrollen](https://example.org/mastr/slot/marktrollen)
...
| ---  | ---  |
| self | mastr:marktrollen |
| native | mastr:marktrollen |
