...
# Slot: bestandsanlageMastrNummer 

<div data-search-exclude markdown="1">



URI: [mastr:slot/bestandsanlageMastrNummer](https://example.org/mastr/slot/bestandsanlageMastrNummer)
...
| Domain Of | [Einheit](../classes/Einheit.md), [EinheitSolar](../classes/EinheitSolar.md), [EinheitWind](../classes/EinheitWind.md) |
...
| ---  | ---  |
| self | mastr:bestandsanlageMastrNummer |
| native | mastr:bestandsanlageMastrNummer |
