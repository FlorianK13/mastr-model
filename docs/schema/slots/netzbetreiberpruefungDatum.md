...
# Slot: netzbetreiberpruefungDatum 


_Datum der letzten Netzbetreiberprüfung, insofern eine durchgeführt wurde_
...
URI: [mastr:slot/netzbetreiberpruefungDatum](https://example.org/mastr/slot/netzbetreiberpruefungDatum)
...
| ---  | ---  |
| self | mastr:netzbetreiberpruefungDatum |
| native | mastr:netzbetreiberpruefungDatum |
...
instantiates:
- xsd:element
description: Datum der letzten Netzbetreiberprüfung, insofern eine durchgeführt wurde
