...
# Slot: datumEndgueltigeStilllegung 


_Datum der endgültigen Stilllegung der Einheit_
...
URI: [mastr:slot/datumEndgueltigeStilllegung](https://example.org/mastr/slot/datumEndgueltigeStilllegung)
...
| ---  | ---  |
| self | mastr:datumEndgueltigeStilllegung |
| native | mastr:datumEndgueltigeStilllegung |
