...
# Class: EinheitStromVerbraucher 

<div data-search-exclude markdown="1">



URI: [mastr:class/EinheitStromVerbraucher](https://example.org/mastr/class/EinheitStromVerbraucher)
...
```mermaid
 classDiagram
    ...
    click EinheitStromVerbraucher href "../../classes/EinheitStromVerbraucher/"
      ...
      EinheitStromVerbraucher : adresszusatz
        
      EinheitStromVerbraucher : altAnlagenbetreiberMastrNummer
        
      EinheitStromVerbraucher : anlagenbetreiberMastrNummer
        
      EinheitStromVerbraucher : anzahlStromverbrauchseinheitenGroesser50Mw
        
      EinheitStromVerbraucher : bestandsanlageMastrNummer
        
      EinheitStromVerbraucher : breitengrad
        
      EinheitStromVerbraucher : bundesland
        
          
    
        
        
        EinheitStromVerbraucher --> "0..1" BundeslaenderEinheiten : bundesland
        click BundeslaenderEinheiten href "../../enums/BundeslaenderEinheiten/"
    

        
      EinheitStromVerbraucher : datumBeginnVoruebergehendeStilllegung
        
      EinheitStromVerbraucher : datumDesBetreiberwechsels
        
      EinheitStromVerbraucher : datumEndgueltigeStilllegung
        
      EinheitStromVerbraucher : datumLetzteAktualisierung
        
      EinheitStromVerbraucher : datumRegistrierungDesBetreiberwechsels
        
      EinheitStromVerbraucher : datumWiederaufnahmeBetrieb
        
      EinheitStromVerbraucher : einheitBetriebsstatus
        
          
    
        
        
        EinheitStromVerbraucher --> "0..1" Betriebsstatus : einheitBetriebsstatus
        click Betriebsstatus href "../../enums/Betriebsstatus/"
    

        
      EinheitStromVerbraucher : einheitMastrNummer
        
      EinheitStromVerbraucher : einheitSystemstatus
        
          
    
        
        
        EinheitStromVerbraucher --> "0..1" Systemstatus : einheitSystemstatus
        click Systemstatus href "../../enums/Systemstatus/"
    

        
      EinheitStromVerbraucher : einsatzverantwortlicher
        
      EinheitStromVerbraucher : flurFlurstuecknummern
        
      EinheitStromVerbraucher : gemarkung
        
      EinheitStromVerbraucher : gemeinde
        
      EinheitStromVerbraucher : gemeindeschluessel
        
      EinheitStromVerbraucher : geplantesInbetriebnahmedatum
        
      EinheitStromVerbraucher : hausnummer
        
      EinheitStromVerbraucher : hausnummerNichtGefunden
        
      EinheitStromVerbraucher : hausnummerNv
        
      EinheitStromVerbraucher : inbetriebnahmedatum
        
      EinheitStromVerbraucher : inbetriebnahmedatumAmAktuellenStandort
        
      EinheitStromVerbraucher : laengengrad
        
      EinheitStromVerbraucher : land
        
          
    
        
        
        EinheitStromVerbraucher --> "0..1" Land : land
        click Land href "../../enums/Land/"
    

        
      EinheitStromVerbraucher : landkreis
        
      EinheitStromVerbraucher : lokationMaStRNummer
        
      EinheitStromVerbraucher : nameStromverbrauchseinheit
        
      EinheitStromVerbraucher : netzbetreiberpruefungDatum
        
      EinheitStromVerbraucher : netzbetreiberpruefungStatus
        
      EinheitStromVerbraucher : nichtVorhandenInMigriertenEinheiten
        
      EinheitStromVerbraucher : ort
        
      EinheitStromVerbraucher : postleitzahl
        
      EinheitStromVerbraucher : registrierungsdatum
        
      EinheitStromVerbraucher : strasse
        
      EinheitStromVerbraucher : strasseNichtGefunden
...
| [nameStromverbrauchseinheit](../slots/nameStromverbrauchseinheit.md) | 0..1 <br/> [String](../types/String.md) | Vom Betreiber frei wählbare Bezeichnung der Stromverbrauchseinheit | direct |
| [anzahlStromverbrauchseinheitenGroesser50Mw](../slots/anzahlStromverbrauchseinheitenGroesser50Mw.md) | 0..1 <br/> [Integer](../types/Integer.md) | Anzahl einzelner Stromverbrauchseinheiten größer 50 MW | direct |
...
| ---  | ---  |
| self | mastr:EinheitStromVerbraucher |
| native | mastr:EinheitStromVerbraucher |
...
attributes:
  ...
  anzahlStromverbrauchseinheitenGroesser50Mw:
    ...
    instantiates:
    - xsd:element
    description: Anzahl einzelner Stromverbrauchseinheiten größer 50 MW
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
    - EinheitStromVerbraucher
