...
URI: [mastr:class/EinheitBiomasse](https://example.org/mastr/class/EinheitBiomasse)
...
```mermaid
 classDiagram
    ...
    click EinheitBiomasse href "../../classes/EinheitBiomasse/"
      ...
      EinheitBiomasse : adresszusatz
        
      EinheitBiomasse : altAnlagenbetreiberMastrNummer
        
      EinheitBiomasse : anlagenbetreiberMastrNummer
        
      EinheitBiomasse : anschlussAnHoechstOderHochSpannung
        
      EinheitBiomasse : bestandsanlageMastrNummer
        
      EinheitBiomasse : biomasseart
        
      EinheitBiomasse : breitengrad
        
      EinheitBiomasse : bruttoleistung
      ...
      EinheitBiomasse : datumEndgueltigeStilllegung
        
      EinheitBiomasse : datumKapazitaetsreserve
        
      EinheitBiomasse : datumLetzteAktualisierung
        
      EinheitBiomasse : datumNetzreserve
        
      EinheitBiomasse : datumRegistrierungDesBetreiberwechsels
        
      EinheitBiomasse : datumWiederaufnahmeBetrieb
        
      EinheitBiomasse : eegMaStRNummer
      ...
      EinheitBiomasse : fernsteuerbarkeitNb
        
      EinheitBiomasse : flurFlurstuecknummern
        
      EinheitBiomasse : gemarkung
        
      EinheitBiomasse : gemeinde
        
      EinheitBiomasse : gemeindeschluessel
        
      EinheitBiomasse : genMastrNummer
      ...
      EinheitBiomasse : hausnummerNichtGefunden
        
      EinheitBiomasse : hausnummerNv
        
      EinheitBiomasse : inbetriebnahmedatum
        
      EinheitBiomasse : inbetriebnahmedatumAmAktuellenStandort
        
      EinheitBiomasse : kapazitaetsreserveZugeordnet
        
      EinheitBiomasse : kraftwerksnummer
        
      EinheitBiomasse : kraftwerksnummerNv
        
      EinheitBiomasse : kwkMaStRNummer
      ...
      EinheitBiomasse : lokationMaStRNummer
        
      EinheitBiomasse : nameStromerzeugungseinheit
        
      EinheitBiomasse : nettonennleistung
        
      EinheitBiomasse : netzbetreiberpruefungDatum
        
      EinheitBiomasse : netzbetreiberpruefungStatus
        
      EinheitBiomasse : netzreserveZugeordnet
        
      EinheitBiomasse : nichtVorhandenInMigriertenEinheiten
        
      EinheitBiomasse : ort
        
      EinheitBiomasse : postleitzahl
        
      EinheitBiomasse : registrierungsdatum
        
      EinheitBiomasse : strasse
        
      EinheitBiomasse : strasseNichtGefunden
        
      EinheitBiomasse : technologie
        
      EinheitBiomasse : weic
        
      EinheitBiomasse : weicDisplayName
        
      EinheitBiomasse : weicNv
...
| ---  | --- | --- | --- |
| [anlagenbetreiberMastrNummer](../slots/anlagenbetreiberMastrNummer.md) | 0..1 <br/> [String](../types/String.md) | MaStR-Nummer des Betreibers der Einheit | direct |
...
| [kwkMaStRNummer](../slots/kwkMaStRNummer.md) | 0..1 <br/> [String](../types/String.md) | MaStR-Nummer der verknüpften KWK-Anlage Ist die Einheit - unter Beteiligung d... | direct |
| [netzreserveZugeordnet](../slots/netzreserveZugeordnet.md) | 0..1 <br/> [Integer](../types/Integer.md) | Bundesnetzagentur - der Netzreserve nach EnWG zugeordnet Datum der Überführun... | direct |
| [datumNetzreserve](../slots/datumNetzreserve.md) | 0..1 <br/> [Datetime](../types/Datetime.md) | Netzreserve Ist die Einheit - unter Beteiligung des Übertragungsnetzbetreiber... | direct |
| [kapazitaetsreserveZugeordnet](../slots/kapazitaetsreserveZugeordnet.md) | 0..1 <br/> [Integer](../types/Integer.md) | Kapazitätsreserve nach dem KapResV zugeordnet? Datum der Überführung in die | direct |
| [datumKapazitaetsreserve](../slots/datumKapazitaetsreserve.md) | 0..1 <br/> [Datetime](../types/Datetime.md) | Kapazitätsreserve | direct |
...
| ---  | ---  |
| self | mastr:EinheitBiomasse |
| native | mastr:EinheitBiomasse |
...
attributes:
  anlagenbetreiberMastrNummer:
    ...
    instantiates:
    - xsd:element
    description: MaStR-Nummer des Betreibers der Einheit
    from_schema: https://example.org/mastr
    domain_of:
    - Einheit
    - EinheitBiomasse
  ...
  genMastrNummer:
    ...
    instantiates:
    - xsd:element
    description: MaStR-Nummer der zu dieser Einheit zugeordneten Genehmigung
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
    - EinheitBiomasse
  ...
  hauptbrennstoff:
    ...
    description: 'Welcher Einsatzstoff oder Brennstoff wird hauptsächlich benutzt.
      Katalogkategorie: BiomasseBrennstoff'
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
    - EinheitBiomasse
  ...
  biomasseart:
    ...
    instantiates:
    - xsd:element
    description: 'Art der Biomasse. Katalogkategorie: BiomasseArt'
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
    - EinheitBiomasse
  ...
  eegMaStRNummer:
    ...
    instantiates:
    - xsd:element
    description: MaStRNummer der zugeordneten EEG-Anlage
    from_schema: https://example.org/mastr
    domain_of:
    - AnlageEegBiomasse
  ...
  kwkMaStRNummer:
    ...
    instantiates:
    - xsd:element
    description: MaStR-Nummer der verknüpften KWK-Anlage Ist die Einheit - unter Beteiligung
      der
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
  ...
  netzreserveZugeordnet:
    ...
    instantiates:
    - xsd:element
    description: Bundesnetzagentur - der Netzreserve nach EnWG zugeordnet Datum der
      Überführung in die
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
  ...
  datumNetzreserve:
    ...
    instantiates:
    - xsd:element
    description: Netzreserve Ist die Einheit - unter Beteiligung des Übertragungsnetzbetreibers
      - der
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
  ...
  kapazitaetsreserveZugeordnet:
    ...
    instantiates:
    - xsd:element
    description: Kapazitätsreserve nach dem KapResV zugeordnet? Datum der Überführung
      in die
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
