...
URI: [mastr:class/EinheitKernkraft](https://example.org/mastr/class/EinheitKernkraft)
...
```mermaid
 classDiagram
    ...
    click EinheitKernkraft href "../../classes/EinheitKernkraft/"
      ...
      EinheitKernkraft : altAnlagenbetreiberMastrNummer
        
      EinheitKernkraft : anlagenbetreiberMastrNummer
        
      EinheitKernkraft : anschlussAnHoechstOderHochSpannung
        
      EinheitKernkraft : bestandsanlageMastrNummer
        
      EinheitKernkraft : breitengrad
        
      EinheitKernkraft : bruttoleistung
        
      EinheitKernkraft : bundesland
        
          
    
        
        
        EinheitKernkraft --> "0..1" BundeslaenderEinheiten : bundesland
        click BundeslaenderEinheiten href "../../enums/BundeslaenderEinheiten/"
    

        
      EinheitKernkraft : datumBeginnVoruebergehendeStilllegung
        
      EinheitKernkraft : datumDesBetreiberwechsels
        
      EinheitKernkraft : datumEndgueltigeStilllegung
        
      EinheitKernkraft : datumKapazitaetsreserve
        
      EinheitKernkraft : datumLetzteAktualisierung
        
      EinheitKernkraft : datumNetzreserve
        
      EinheitKernkraft : datumRegistrierungDesBetreiberwechsels
        
      EinheitKernkraft : datumWiederaufnahmeBetrieb
        
      EinheitKernkraft : einheitBetriebsstatus
        
          
    
        
        
        EinheitKernkraft --> "0..1" Betriebsstatus : einheitBetriebsstatus
        click Betriebsstatus href "../../enums/Betriebsstatus/"
    

        
      EinheitKernkraft : einheitMastrNummer
        
      EinheitKernkraft : einheitSystemstatus
        
          
    
        
        
        EinheitKernkraft --> "0..1" Systemstatus : einheitSystemstatus
        click Systemstatus href "../../enums/Systemstatus/"
    

        
      EinheitKernkraft : einsatzverantwortlicher
        
      EinheitKernkraft : einspeisungsart
        
          
    
        
        
        EinheitKernkraft --> "0..1" Einspeisungsart : einspeisungsart
        click Einspeisungsart href "../../enums/Einspeisungsart/"
    

        
      EinheitKernkraft : energietraeger
        
          
    
        
        
        EinheitKernkraft --> "0..1" Energietraeger : energietraeger
        click Energietraeger href "../../enums/Energietraeger/"
    

        
      EinheitKernkraft : fernsteuerbarkeitDv
        
      EinheitKernkraft : fernsteuerbarkeitNb
        
      EinheitKernkraft : flurFlurstuecknummern
        
      EinheitKernkraft : gemarkung
        
      EinheitKernkraft : gemeinde
        
      EinheitKernkraft : gemeindeschluessel
        
      EinheitKernkraft : genMastrNummer
        
      EinheitKernkraft : geplantesInbetriebnahmedatum
        
      EinheitKernkraft : hausnummer
        
      EinheitKernkraft : hausnummerNichtGefunden
        
      EinheitKernkraft : hausnummerNv
        
      EinheitKernkraft : inbetriebnahmedatum
        
      EinheitKernkraft : inbetriebnahmedatumAmAktuellenStandort
        
      EinheitKernkraft : kapazitaetsreserveZugeordnet
        
      EinheitKernkraft : kraftwerksnummer
        
      EinheitKernkraft : kraftwerksnummerNv
        
      EinheitKernkraft : laengengrad
        
      EinheitKernkraft : land
        
          
    
        
        
        EinheitKernkraft --> "0..1" Land : land
        click Land href "../../enums/Land/"
    

        
      EinheitKernkraft : landkreis
        
      EinheitKernkraft : lokationMaStRNummer
        
      EinheitKernkraft : nameKraftwerk
        
      EinheitKernkraft : nameKraftwerksblock
        
      EinheitKernkraft : nameStromerzeugungseinheit
        
      EinheitKernkraft : nettonennleistung
        
      EinheitKernkraft : netzbetreiberpruefungDatum
        
      EinheitKernkraft : netzbetreiberpruefungStatus
        
      EinheitKernkraft : netzreserveZugeordnet
        
      EinheitKernkraft : nichtVorhandenInMigriertenEinheiten
        
      EinheitKernkraft : ort
        
      EinheitKernkraft : postleitzahl
        
      EinheitKernkraft : registrierungsdatum
        
      EinheitKernkraft : strasse
        
      EinheitKernkraft : strasseNichtGefunden
        
      EinheitKernkraft : technologie
        
          
    
        
        
        EinheitKernkraft --> "0..1" TechnologieKernkraft : technologie
        click TechnologieKernkraft href "../../enums/TechnologieKernkraft/"
    

        
      EinheitKernkraft : weic
        
      EinheitKernkraft : weicDisplayName
        
      EinheitKernkraft : weicNv
...
| [nameKraftwerk](../slots/nameKraftwerk.md) | 0..1 <br/> [String](../types/String.md) | Vom Betreiber frei wählbare Bezeichnung des Kraftwerks, dessen Teil die Strom... | direct |
...
| [technologie](../slots/technologie.md) | 0..1 <br/> [TechnologieKernkraft](../enums/TechnologieKernkraft.md) | Technologie der Stromerzeugung | direct |
...
| ---  | ---  |
| self | mastr:EinheitKernkraft |
| native | mastr:EinheitKernkraft |
...
attributes:
  ...
  nameKraftwerk:
    ...
    instantiates:
    - xsd:element
    description: Vom Betreiber frei wählbare Bezeichnung des Kraftwerks, dessen Teil
      die Stromerzeugungseinheit ist.
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
    - EinheitKernkraft
  ...
  technologie:
    ...
    instantiates:
    - xsd:element
    description: 'Technologie der Stromerzeugung. Katalogkategorie: TechnologieKernkraft'
    from_schema: https://example.org/mastr
    domain_of:
    - EinheitBiomasse
    - EinheitGasErzeuger
