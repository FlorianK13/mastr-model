...
# Class: EinheitGasSpeicher 

<div data-search-exclude markdown="1">



URI: [mastr:class/EinheitGasSpeicher](https://example.org/mastr/class/EinheitGasSpeicher)
...
```mermaid
 classDiagram
    ...
    click EinheitGasSpeicher href "../../classes/EinheitGasSpeicher/"
      ...
      EinheitGasSpeicher : adresszusatz
        
      EinheitGasSpeicher : altAnlagenbetreiberMastrNummer
        
      EinheitGasSpeicher : anlagenbetreiberMastrNummer
        
      EinheitGasSpeicher : bestandsanlageMastrNummer
        
      EinheitGasSpeicher : breitengrad
      ...
      EinheitGasSpeicher : datumEndgueltigeStilllegung
        
      EinheitGasSpeicher : datumLetzteAktualisierung
        
      EinheitGasSpeicher : datumRegistrierungDesBetreiberwechsels
        
      EinheitGasSpeicher : datumWiederaufnahmeBetrieb
        
      EinheitGasSpeicher : durchschnittlicherBrennwert
      ...
      EinheitGasSpeicher : gemarkung
        
      EinheitGasSpeicher : gemeinde
        
      EinheitGasSpeicher : gemeindeschluessel
        
      EinheitGasSpeicher : geplantesInbetriebnahmedatum
        
      EinheitGasSpeicher : hausnummer
        
      EinheitGasSpeicher : hausnummerNichtGefunden
        
      EinheitGasSpeicher : hausnummerNv
        
      EinheitGasSpeicher : inbetriebnahmedatum
        
      EinheitGasSpeicher : inbetriebnahmedatumAmAktuellenStandort
      ...
      EinheitGasSpeicher : lokationMaStRNummer
        
      EinheitGasSpeicher : maximaleAusspeicherleistung
        
      EinheitGasSpeicher : maximaleEinspeicherleistung
        
      EinheitGasSpeicher : maximalNutzbaresArbeitsgasvolumen
        
      EinheitGasSpeicher : nameGasspeicher
        
      EinheitGasSpeicher : netzbetreiberpruefungDatum
        
      EinheitGasSpeicher : netzbetreiberpruefungStatus
        
      EinheitGasSpeicher : nichtVorhandenInMigriertenEinheiten
        
      EinheitGasSpeicher : ort
        
      EinheitGasSpeicher : postleitzahl
      ...
      EinheitGasSpeicher : strasse
        
      EinheitGasSpeicher : strasseNichtGefunden
        
      EinheitGasSpeicher : weic
        
      EinheitGasSpeicher : weicNa
...
| [durchschnittlicherBrennwert](../slots/durchschnittlicherBrennwert.md) | 0..1 <br/> [Float](../types/Float.md) | Durchschnittlicher Brennwert des Gas im Speicher | direct |
| [weic](../slots/weic.md) | 0..1 <br/> [String](../types/String.md) | W-Code der Einheit | direct |
| [weicNa](../slots/weicNa.md) | 0..1 <br/> [Integer](../types/Integer.md) |  | direct |
| [speicherMaStRNummer](../slots/speicherMaStRNummer.md) | 0..1 <br/> [String](../types/String.md) | MaStR-Nummer der zu dieser Einheit zugeordneten Gasspeicheranlage | direct |
| [inbetriebnahmedatumAmAktuellenStandort](../slots/inbetriebnahmedatumAmAktuellenStandort.md) | 0..1 <br/> [Date](../types/Date.md) | Datum der Inbetriebnahme am aktuellen Standort | direct |
...
| ---  | ---  |
| self | mastr:EinheitGasSpeicher |
| native | mastr:EinheitGasSpeicher |
...
attributes:
  ...
  nameGasspeicher:
    ...
    instantiates:
    - xsd:element
    description: Vom Betreiber frei wählbare Bezeichnung der Gasspeichereinheit.
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
    - EinheitGasSpeicher
  ...
  maximalNutzbaresArbeitsgasvolumen:
    ...
    instantiates:
    - xsd:element
    description: Maximal nutzbares Arbeitsgasvolumen
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
    - EinheitGasSpeicher
  ...
  maximaleEinspeicherleistung:
    ...
    instantiates:
    - xsd:element
    description: Maximale Einspeicherleistung
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
    - EinheitGasSpeicher
  ...
  maximaleAusspeicherleistung:
    ...
    instantiates:
    - xsd:element
    description: Maximale Ausspeicherleistung
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
    - EinheitGasSpeicher
  ...
  durchschnittlicherBrennwert:
    ...
    instantiates:
    - xsd:element
    description: Durchschnittlicher Brennwert des Gas im Speicher
    from_schema: https://example.org/mastr
    rank: 1000
    domain_of:
    - EinheitGasSpeicher
  ...
  weic:
    ...
    instantiates:
    - xsd:element
    description: W-Code der Einheit
    from_schema: https://example.org/mastr
    domain_of:
    - EinheitBiomasse
    - EinheitGasSpeicher
  ...
  speicherMaStRNummer:
    ...
    instantiates:
    - xsd:element
    description: MaStR-Nummer der zu dieser Einheit zugeordneten Gasspeicheranlage
    from_schema: https://example.org/mastr
    domain_of:
    - EinheitGasErzeuger
    - EinheitGasSpeicher
